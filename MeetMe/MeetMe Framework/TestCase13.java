...
public class TestCase13 {
	...
	public void test() throws ParseException {
		...
		Date eventFromDate = setDate("2014-11-22 00:00:00");
		meetingEvent.setFromDate(eventFromDate);
		Date eventToDate = setDate("2014-11-22 23:00:00");
		...
		// cek validasi event
		boolean checkValidityofEventDate = false;
		Calendar calendar = Calendar.getInstance();
		long longFrom = (long) meetingEvent.getFromDate().getTime();
		long longNow = (long) calendar.getTime().getTime();
		if (longFrom < longNow) {
			checkValidityofEventDate = false;
		} else {
			checkValidityofEventDate = true;

		}
		assertEquals(false, checkValidityofEventDate);
		...
		Date fromPlausibleTime = setDate("2014-11-22 06:00:00");
		Date toPlausibleTime = setDate("2014-11-22 07:00:00");
		...
		fromPlausibleTime = setDate("2014-11-22 11:00:00");
		toPlausibleTime = setDate("2014-11-22 12:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 3
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2014-11-22 12:00:00");
		toPlausibleTime = setDate("2014-11-22 13:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 4
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2014-11-22 16:00:00");
		toPlausibleTime = setDate("2014-11-22 17:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);

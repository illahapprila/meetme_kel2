...
public class case16 {
	...
	public void test() throws ParseException {
		...
		Date fromPlausibleTime = setDate("2015-12-31 00:00:00");
		Date toPlausibleTime = setDate("2015-12-31 02:00:00");
		...
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2015-12-31 02:00:00");
		toPlausibleTime = setDate("2015-12-31 04:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 3
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2015-12-31 04:00:00");
		toPlausibleTime = setDate("2015-12-31 06:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 4
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2015-12-31 21:00:00");
		toPlausibleTime = setDate("2015-12-31 23:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 4b
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2015-12-31 23:00:00");
		toPlausibleTime = setDate("2016-01-01 01:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 5
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2016-01-01 01:00:00");
		toPlausibleTime = setDate("2016-01-01 03:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 6
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2016-01-01 03:00:00");
		toPlausibleTime = setDate("2016-01-01 05:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 6
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2016-01-01 22:00:00");
		toPlausibleTime = setDate("2016-01-01 23:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);

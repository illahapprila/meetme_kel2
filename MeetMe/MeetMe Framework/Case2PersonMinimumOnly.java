...
public class Case2PersonMinimumOnly {
	...
	public void test() throws ParseException {
		...
		attendance.setName("Tigaan");
		attendance.getPersons().add(Bima);
		...
		// add plausible time 1
		fromPlausibleTime = setDate("2015-12-31 22:00:00");
		toPlausibleTime = setDate("2016-1-1 00:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);

...
public class TestCase5 {
	...
	@Test
	public void testPlausibleTimeCase5() throws ParseException {
		...
		Date toDate = setDate("2015-10-31 00:00:00");
		...
		toDate = setDate("2015-11-01 00:00:00");
		...
		Date eventToDate = setDate("2015-11-03 00:00:00");
		...
		PlausibleTimeCalculatorInterface plausibleTimeCalculator = new JoePlausibleTimeCalculator(100, 100);
		...
		Date fromPlausibleTime = setDate("2015-11-01 00:00:00");
		Date toPlausibleTime = setDate("2015-11-01 12:00:00");
		...
		fromPlausibleTime = setDate("2015-11-01 12:00:00");
		toPlausibleTime = setDate("2015-11-02 00:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);
		// add plausible time 3
		plausibleTime = new PlausibleTime();
		fromPlausibleTime = setDate("2015-11-02 00:00:00");
		toPlausibleTime = setDate("2015-11-02 12:00:00");
		plausibleTime.setFrom(fromPlausibleTime);
		plausibleTime.setTo(toPlausibleTime);
		plausibleTimes.add(plausibleTime);

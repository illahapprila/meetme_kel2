...
public class OnePlausibleTime {
	...
	public static void main(String[] args) throws ParseException {
		...
		meetingEvent.setMeetingDurationInMinutes(4 * 60);
		...
		PlausibleTimeCalculatorInterface plausibleTimeCalculator = new JoePlausibleTimeCalculator(1 * 60, 100);
	...
	public static void printMeetingEventInfo(MeetingEvent meetingEvent) {
		...
		System.out.println("Meet" + "ing Planer :" + meetingEvent.getMeetingPlanner().getName());

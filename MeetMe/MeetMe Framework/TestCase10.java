...
public class TestCase10 {
	...
	public void test() throws ParseException {
		...
		BusyTime bimaBusyTime1 = new BusyTime(7 * 60, toDate);
		...
		Date eventFromDate = setDate("2016-01-01 12:00:00");
		meetingEvent.setFromDate(eventFromDate);
		Date eventToDate = setDate("2016-01-01 00:00:00");
		...
		// apabila jumlah plausible timenya sama
		// assertEquals(2,i);
